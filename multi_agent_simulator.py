...
class MultiAgentSimulator:
    ...
    def step(self) -> bool:
        ...
        for agent_id, agent in self.agents.items():
            ...
            # Move agent
            success, reward = self.grid_world.move_agent(agent_id, next_pos)
            ...
            if success:
                ...
                if isinstance(agent, RLAgent) and agent.last_state is not None:
                    current_pos = self.grid_world.agents[agent_id]
                    goal = self.grid_world.agent_goals[agent_id]
                ...
                if isinstance(agent, RLAgent):
                    agent.last_state = self.grid_world.agents[agent_id]
    ...
    def calculate_metrics(self) -> Dict:
        ...
        for agent_id, agent in self.agents.items():
            ...
            agent_metrics = {
                ...
                'efficiency': agent.total_reward / max(agent.steps_taken, 1)
            }
